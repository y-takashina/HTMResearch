...
namespace Detector
{
    public class HTMDetector
    {
        ...
        public void Detect()
        {
            ...
            // Level 2
            probabilities2 = membership12.PseudoInverse().Mul(probabilities1).Mul(membership12);
            for (var j = 0; j < N2; j++)
            {
                for (var k = 0; k < N2; k++)
                {
            ...
            // Level 3
            probabilities3 = membership23.PseudoInverse().Mul(probabilities2).Mul(membership23);
            for (var j = 0; j < N3; j++)
            {
                for (var k = 0; k < N3; k++)
                {
